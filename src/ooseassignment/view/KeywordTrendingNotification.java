/************************************************************
 *Name: Kay Men Yap
 *File name: KeywordTrendingNotification.java
...
import ooseassignment.model.KeywordTrendingObserver;
public class KeywordTrendingNotification implements KeywordTrendingObserver
{
	...
	public KeywordTrendingNotification(Person person, SMS sms, FacebookMessenger facebookMessenger, TwitterMessenger twitterMessenger)
	{
		this.person = person;
		this.sms = sms;
    ...
    /*
    notifies the person about keyword trending through all contact details that are present in person
    */
    @Override
